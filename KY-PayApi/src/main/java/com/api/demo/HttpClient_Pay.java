...
//			Document document = (Document) db.parse(body);
//			
//			NodeList node = document.getElementsByTagName("学生");
	...
	public static void OutQueryCreate() {
		try {
			...
			map.put("account_no", "6217002670008672307");
	 ...
	 * 余额查询
	 */
	public static void queryYE() {
		try {
		String url="https://manager.jifenmy.com/zfs_trade_gw/order/queryAccountBalance.do";
		TreeMap<String, String> map = new TreeMap<String, String>();  
		map.put("interface_version", "V1.0");
		map.put("merchant_no","B00100100100101001");
		map.put("sign_type","RSA-S");
